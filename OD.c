...
typedef struct {
    ...
    OD_obj_var_t o_2110_myvar;
    OD_obj_var_t o_2111_ledint;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2110_myvar = {
        .dataOrig = &OD_RAM.x2110_myvar,
        .attribute = ODA_SDO_RW | ODA_RPDO | ODA_MB,
        .dataLength = 4
    },
    .o_2111_ledint = {
        .dataOrig = &OD_RAM.x2111_ledint,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2110, 0x01, ODT_VAR, &ODObjs.o_2110_myvar, NULL},
    {0x2111, 0x01, ODT_VAR, &ODObjs.o_2111_ledint, NULL},
