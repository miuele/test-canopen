...
typedef struct {
    ...
    uint32_t x2110_myvar;
    uint8_t x2111_ledint;
} OD_RAM_t;
...
#define OD_ENTRY_H2111 &OD->list[34]
...
#define OD_ENTRY_H2110_myvar &OD->list[33]
#define OD_ENTRY_H2111_ledint &OD->list[34]
